...
//! # GDExtension API for Godot 4.5.1
...
/// not published).
pub const GODOT_VERSION_STRING: &str = "4.5.1";
...
pub fn load_gdextension_header_rs_for_platform(platform: TargetPlatform) -> CowStr {
    let s = match platform {
        TargetPlatform::Windows => include_str!("../../4.5/res/gdextension_interface_windows.rs"),
        TargetPlatform::MacOS => include_str!("../../4.5/res/gdextension_interface_macos.rs"),
        TargetPlatform::Linux => include_str!("../../4.5/res/gdextension_interface_linux.rs"),
        TargetPlatform::Wasm => include_str!("../../4.5/res/gdextension_interface_wasm.rs"),
    };
